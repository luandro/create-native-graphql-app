...
* [I want to build my app to publish to the App Store or Play Store](https://github.com/luandro/create-native-graphql-app/blob/master/native-graphql-scripts/template/README.md#sharing-and-deployment)
