...
[![npm version](https://badge.fury.io/js/create-native-graphql-app.svg)](https://badge.fury.io/js/create-native-graphql-app)

Create React Native apps with no build configuration.

* [Getting Started](#getting-started)
* [User Guide](https://github.com/luandro/create-native-graphql-app/blob/master/native-graphql-scripts/template/README.md)
...
* The issue is not covered in the [Getting Started](https://github.com/luandro/create-native-graphql-app#getting-started) or [User Guide](https://github.com/luandro/create-native-graphql-app/blob/master/native-graphql-scripts/template/README.md) documentation
* There is not already an [open issue](https://github.com/luandro/create-native-graphql-app/issues) for your particular problem
...
If you're sure that you need custom native code, please read the [ejecting guide](https://github.com/luandro/create-native-graphql-app/blob/master/EJECTING.md).
...
Contributions will be licensed under the [3-clause BSD license](https://github.com/luandro/create-native-graphql-app/blob/master/LICENSE). Please fork the repository, perform your work on a feature branch, and submit a pull request to this repository's master branch from your fork's branch.

For details about setting up a development environment and testing your changes, please see [CONTRIBUTING.md](https://github.com/luandro/create-native-graphql-app/blob/master/CONTRIBUTING.md).
